          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <button 
                ...
                className="w-full sm:w-auto btn-secondary px-10 py-4 rounded-2xl font-black uppercase tracking-widest text-sm shadow-xl shadow-secondary/30"
              >
                Réserver mon stand
              </button>
            ...
            {plans.map((plan) => (
              <motion.div
                ...
                className={cn(
                  ...
                  plan.color,
                  plan.textColor,
                  plan.popular ? "shadow-2xl shadow-primary/20 scale-105 z-10 border-transparent" : "border-gray-200"
                )}
              >
                {plan.popular && (
