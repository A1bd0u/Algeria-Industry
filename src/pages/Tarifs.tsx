  ...
  return (
    <div className="pt-16 pb-20 bg-gray-50/50 min-h-screen relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
            ...
            {exhibitorPlans.map((plan, i) => (
              <motion.div 
                ...
                className={cn(
                  ...
                  plan.color,
                  plan.popular 
                    ? "ring-4 ring-secondary/20 shadow-2xl shadow-secondary/20 scale-105 z-10 border-transparent" 
              ...
              >
                ...
                <Link 
                  ...
                  className={cn(
                    ...
                    plan.popular 
                      ? "bg-secondary border-secondary text-white hover:bg-white hover:text-secondary hover:border-white shadow-lg shadow-secondary/30" 
        ...
        <div className="mt-32 max-w-4xl mx-auto bg-white rounded-[40px] p-12 text-center shadow-xl shadow-gray-200/50 border border-gray-100 relative overflow-hidden group">
