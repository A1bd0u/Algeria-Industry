...
const ConsolePro = () => {
  ...
  const [categories, setCategories] = useState([
    { id: 1, name: 'Énergie & Pétrole', subCategories: [{id: 1, name: 'Extraction'}, {id: 2, name: 'Raffinage'}] },
    { id: 2, name: 'BTP & Construction', subCategories: [{id: 3, name: 'Gros Oeuvre'}, {id: 4, name: 'Second Oeuvre'}] },
    { id: 3, name: 'Mécanique de Précision', subCategories: [{id: 5, name: 'Usinage'}, {id: 6, name: 'Assemblage'}] },
    { id: 4, name: 'Agriculture & Agro', subCategories: [{id: 7, name: 'Matériel agricole'}] },
    { id: 5, name: 'Textile & Confection', subCategories: [{id: 8, name: 'Tissus techniques'}] },
  ]);
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-8">
               ...
               <div className="bg-white p-8 rounded-[32px] border border-gray-100 shadow-sm space-y-8">
                  ...
                  <div className="pt-6 border-t border-gray-50 flex justify-end">
                    <button onClick={handleSaveCategorySettings} className="bg-primary text-white px-8 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest shadow-lg shadow-primary/20 hover:bg-primary/90 transition-all">
