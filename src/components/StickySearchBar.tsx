          ...
          <div className={cn("flex items-center space-x-4", i18n.language === 'ar' && "flex-row-reverse space-x-reverse")}>
            <div className="flex-1 relative group">
              ...
              <button
                ...
                className={cn(
                  "w-full bg-gray-50 border border-gray-100 rounded-2xl py-4 text-sm font-medium text-gray-400 hover:bg-white hover:border-secondary/30 hover:shadow-lg hover:shadow-secondary/5 transition-all text-left",
              ...
              <div className={cn(
                ...
                i18n.language === 'ar' ? "left-0 pl-2 space-x-reverse" : "right-0 pr-2"
                 ...
                 <button 
                  onClick={() => setIsSearchOpen(true)}
                  className="bg-secondary text-white px-6 py-2.5 rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-primary transition-all shadow-lg shadow-secondary/20"
                 >
                    {t('hero.search_btn')}
                 </button>
              </div>
