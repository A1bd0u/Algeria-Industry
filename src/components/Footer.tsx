        ...
        <div className={cn("grid grid-cols-1 md:grid-cols-4 gap-16 mb-20", i18n.language === 'ar' && "md:flex md:flex-row-reverse md:justify-between")}>
          ...
          <div className={i18n.language === 'ar' ? "text-right" : ""}>
            ...
            <ul className="space-y-4 text-[11px] font-bold uppercase tracking-wider text-gray-400">
              ...
              <li><Link to="/tenders" className={cn("hover:text-secondary transition-colors flex items-center space-x-2", i18n.language === 'ar' && "flex-row-reverse space-x-reverse")}><span>{i18n.language === 'ar' ? '<' : '>'}</span> <span>{t('nav.tenders')}</span></Link></li>
              <li><Link to="/virtual-show" className={cn("hover:text-secondary transition-colors flex items-center space-x-2", i18n.language === 'ar' && "flex-row-reverse space-x-reverse")}><span>{i18n.language === 'ar' ? '<' : '>'}</span> <span>{t('nav.virtual_show')}</span></Link></li>
