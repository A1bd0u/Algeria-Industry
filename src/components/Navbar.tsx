...
const Navbar = () => {
  ...
  const categories = [
    { name: t('categories.machine_tools'), val: 'MACHINES-OUTILS', icon: Wrench },
    { name: t('categories.production_machines'), val: 'MACHINES DE PRODUCTION', icon: Settings },
    { name: t('categories.industrial_equipment'), val: 'MACHINES ET ÉQUIPEMENTS INDUSTRIELS', icon: Component },
    { name: t('categories.agrifood'), val: 'INDUSTRIE AGROALIMENTAIRE', icon: Package },
    { name: t('categories.logistics'), val: 'LOGISTIQUE - TRANSPORT - MANUTENTION', icon: Truck },
    { name: t('categories.hse'), val: 'HYGIÈNE - SÉCURITÉ - ENVIRONNEMENT', icon: ShieldCheck },
    { name: t('categories.building'), val: 'BÂTIMENT - TRAVAUX', icon: HardHat }
  ];
        ...
        <div className={cn("flex justify-between h-24 items-center gap-4 lg:gap-6", i18n.language === 'ar' && "flex-row-reverse")}>
          <div className={cn("flex items-center space-x-4 lg:space-x-6", i18n.language === 'ar' && "space-x-reverse")}>
            ...
            <Link to="/" onClick={handleLogoClick} className="flex items-center space-x-3 group min-w-max">
              <div className="w-11 h-11 bg-gradient-to-br from-secondary to-secondary/80 rounded-xl flex items-center justify-center group-hover:rotate-12 transition-all duration-500 shadow-lg shadow-black/40">
          ...
          <div className={cn("hidden lg:flex items-center space-x-0.5", i18n.language === 'ar' && "space-x-reverse")}>
                ...
                <Link
                  ...
                  className={cn(
                    ...
                    location.pathname === item.path 
                      ? "bg-white text-[#1a1a1a] shadow-lg shadow-white/10" 
            ...
            <Link 
              to="/become-exhibitor" 
              className="relative group px-5 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-[0.2em] transition-all duration-500 flex items-center space-x-2 bg-secondary text-white hover:bg-secondary/90 shadow-lg shadow-secondary/10 shrink-0"
            >
                      ...
                      <div className="mt-2 p-2 bg-gradient-to-t from-white/[0.02] to-transparent rounded-xl border-t border-white/5">
                        {!isAuthenticated ? (
                          <div className="grid grid-cols-2 gap-2">
                            ...
                            <Link
                              to="/register"
                              className="flex items-center justify-center py-3 rounded-xl bg-secondary text-white hover:bg-secondary/90 text-[10px] font-black uppercase tracking-widest transition-all shadow-lg shadow-secondary/20"
                            >
            ...
            <div className="px-4 pt-4 pb-12 space-y-2">
              ...
              <div className="grid grid-cols-1 gap-3">
                <Link
                  to="/become-exhibitor"
                  onClick={() => setIsOpen(false)}
                  className="flex items-center space-x-4 px-4 py-4 rounded-xl text-xs font-black uppercase tracking-widest bg-secondary text-white shadow-xl shadow-secondary/20"
                >
                ...
                <div className="bg-white/5 rounded-[24px] p-3 border border-white/5 shadow-2xl">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Link
                      to="/register"
                      onClick={() => setIsOpen(false)}
                      className="flex-1 py-4 bg-secondary rounded-xl text-center text-[10px] font-black uppercase tracking-widest text-white shadow-lg shadow-secondary/20"
                    >
                      {i18n.language === 'ar' ? 'تسجيل' : 'Inscription'}
                    </Link>
                  </div>
